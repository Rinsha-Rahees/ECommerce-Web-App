      ...
      <Transition appear show={isCartOpen} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          <Transition.Child
            ...
            leaveTo="opacity-0">
            <div className="fixed h-full inset-0 bg-black/75" />
          </Transition.Child>

          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex h-full justify-end font-mono">
              <Transition.Child
                as={Fragment}
                ...
                <Dialog.Panel className="w-full max-w-xs transform overflow-hidden bg-white text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
                    className="flex items-center justify-between text-lg font-semibold py-3 px-4 text-gray-900">
