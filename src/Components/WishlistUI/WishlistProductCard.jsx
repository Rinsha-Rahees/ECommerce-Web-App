  ...
  return (
    <div className="flex flex-col h-fit w-full py-2">
      ...
      <div className="flex items-center h-fit w-full">
        ...
        className="bg-black text-white font-bold h-10 w-[85%] rounded-bl-lg">ADD TO CART
        </button>
      ...
      <span className="font-semibold text-md leading-3">{productDetails?.priceString}</span>
    </div>
  );
}
